    ...
    return (
        ...
        <div className="flexContainer">
          ...
          <div className="flexside">
            <h3>PhD - Geological Sciences</h3>
            <h3>GPA: 3.55</h3>
            <h3>Graduated Dec 2017</h3>
          </div>
          ...
          <div className="flexsideCenter">
            ...
            <hr class="solid"></hr>
            <h4>Thesis: <a class="link-primary" href="https://repositories.lib.utexas.edu/handle/2152/63852">
                Compositional Changes of Light Hydrocarbons during Migration through Overburden</a></h4>
            ...
            <h4><a class="link-primary" href="https://onlinelibrary.wiley.com/doi/abs/10.1002/ghg.1841">
                ...
                migration as an analogue for potential
